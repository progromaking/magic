...
#Область _ // Сохранение значений для отладки

Процедура СохранитьЗначениеОтладки(Значение, ДополнительныйКлюч = "") Экспорт
	
	КлючОбъекта = "Отладка";
	ХранилищеОбщихНастроек.Сохранить(КлючОбъекта, ДополнительныйКлюч, Значение);
	
КонецПроцедуры

Функция ПолучитьЗначениеОтладки(ДополнительныйКлюч = "") Экспорт
	
	КлючОбъекта = "Отладка";
	Возврат ХранилищеОбщихНастроек.Загрузить(КлючОбъекта, ДополнительныйКлюч);
