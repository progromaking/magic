...
Процедура ОткрытьФормуСПараметрами(Команда)
	...
	// Вариант 3
	//// Открытие формы документа из списка
	//Ссылка = Элементы.Список.ТекущаяСтрока;
	//ПараметрыОткрываемойФормы.Вставить("Ключ", Ссылка);	
	//
	//Путь = "C:\Users\yur\Desktop\Временные\Документ_ЗаказПоставщику_ФормаДокумента.epf";
	//ИмяОбработки = ПодключитьВнешнююОбработкуНаКлиенте(Путь);
	//ПолноеИмяФормы = "ВнешняяОбработка."+ ИмяОбработки +".ФормаОбъекта";	
