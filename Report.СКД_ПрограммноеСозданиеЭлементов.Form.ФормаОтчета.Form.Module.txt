...
Функция ИзменитьСКД()
	...
	//АдресВременногоХранилищаСхемы = ПоместитьВоВременноеХранилище(СКД, УникальныйИдентификатор);
	...
	//Возврат АдресВременногоХранилищаСхемы;
...
Процедура ИзменитьСКД1(Команда)
	АдресВременногоХранилищаСхемы = ИзменитьСКД();
КонецПроцедуры
